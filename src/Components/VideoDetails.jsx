                ...
                <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
                    ...
                    <div className="flex justify-between flex-col md:flex-row mt-4">
                            ...
                            <div className="flex flex-col ml-3">
                                <div className="text-black dark:text-white text-md font-semibold flex items-center">
                                    ...
                                    {video?.author?.badges[0]?.type ===
                                        "VERIFIED_CHANNEL" && (
                                        <BsFillCheckCircleFill className="text-black dark:text-white/[0.5] text-[12px] ml-1" />
                                    )}
                                </div>
                        ...
                        <div className="flex text-black dark:text-white mt-4 md:mt-0">
                            <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-black/[0.1] dark:bg-white/[0.15]">
                                <AiOutlineLike className="text-xltext-black dark:text-white mr-2" />
                                {`${abbreviateNumber(
                                    video?.stats?.views,
                                    2
                                )} Likes`}
                            </div>
                            <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-black/[0.1] dark:bg-white/[0.15] ml-4">
                                {`${abbreviateNumber(
                                    video?.stats?.views,
                                    2
                                )} Views`}
